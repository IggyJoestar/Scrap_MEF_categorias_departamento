...
# Años de consulta
YEARS = list(range(2019, 2023))  # no incluye el límite superior
...
ROUTES = {
    ...
    "JUSTINE": {
        "levels":{
            ...
            "level_2": {  
                "button": "ctl00_CPH1_BtnFuncion", 
                "list_xpath": "//tr[starts-with(@id, 'tr')]",
                "name_xpath": "./td[2]",
                "next_level": "level_3",
            },
            "level_3": {  # 
                "button": "ctl00_CPH1_BtnGenerica", # ctl00_CPH1_BtnGenerica
                "list_xpath": None,
                "name_xpath": None,
                "table_id": "ctl00_CPH1_Mt0",
                "next_level": None,  # Último nivel
    ...
    # Ruta 3 ctl00_CPH1_BtnProgramaPpto
    "Projects": {
        "levels": {
            "level_1": {  # Detalle niveles de gobierno  #buton
                "button": "ctl00_CPH1_BtnTipoGobierno",
                "list_xpath": None,
                "next_level": "level_2",
            },
            "level_2": {  # Nivel de gobierno: Local  #select
                "button": "ctl00_CPH1_RptData_ctl02_TD0",
                "list_xpath": None,
                "next_level": "level_3",
            },
            "level_3": {  # Detalle niveles de gobierno  #buton
                "button": "ctl00_CPH1_BtnSubTipoGobierno",
                "list_xpath": None,
                "next_level": "level_4",
            },
            "level_4": {  # municipalidades : Local  #select
                "button": "ctl00_CPH1_RptData_ctl01_TD0",
                "list_xpath": None,
                "next_level": "level_5",
            },
            "level_5": {  # Categoria presupuestal  #boton
                "button": "ctl00_CPH1_BtnProgramaPpto",
                "list_xpath": None,
                "next_level": "level_6",
            },
            "level_6": {  # municipalidades : Local  #select
                "button": "ctl00_CPH1_RptData_ctl16_TD0",
                "list_xpath": None,
                "next_level": "level_7",
            },
            "level_7": {  # Categoria presupuestal  #boton
                "button": "ctl00_CPH1_BtnDepartamento",
                "list_xpath": None,
                "next_level": "level_8",
            },
            "level_8": {  # municipalidades : Local  #select
                "button": "ctl00_CPH1_RptData_ctl15_TD0",
                "list_xpath": None,
                "next_level": "level_9",
            },
            "level_9": {  # Categoria presupuestal  #boton
                "button": "ctl00_CPH1_BtnMunicipalidad",
                "list_xpath": None,
                "next_level": "level_10",
            },
            "level_10": {  # municipalidades : Local  #select
                "button": "ctl00_CPH1_RptData_ctl18_TD0",
                "list_xpath": None,
                "next_level": "level_11",
            },
            "level_11": {  # Categoria presupuestal  #boton
                "button": "ctl00_CPH1_BtnProdProy",
                "list_xpath": None,
                "name_xpath": None,
                "table_id": "ctl00_CPH1_Mt0",
                "next_level": None,  # Último nivel
...
FILE_CONFIGS = {
    ...
    "JUSTINE": {
        "ENCABEZADOS_BASE": ["Año","Departamento", "Funcion"],
        "ARCHIVO_SCRAPING": "Justine.xlsx",
    },
    "Projects": {
        "ENCABEZADOS_BASE": ["Año"],
        "ARCHIVO_SCRAPING": "EJECUCION_GASTO_GN_X_SECTORES.xlsx",
    },
}
